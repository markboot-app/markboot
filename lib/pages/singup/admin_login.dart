...
class _AdminPageState extends State<AdminPage> {
        ...
        child: Container(
          ...
          child:Column(
            ...
            children: <Widget>[
              ...
              commonWidget.commonTextField(controller: emailCont,hintText: "Email",
              ),
  ...
  userLogin() async {
    try{
      ...
      FirebaseAuth auth = FirebaseAuth.instance;
      AuthResult authResult = await auth.signInWithEmailAndPassword(email: emialNo, password: password);
      debugPrint("authRes - ${authResult.user.isEmailVerified}");
      if(authResult.user.isEmailVerified == true) {
        debugPrint("HIII");
       QuerySnapshot querySnapshot = await Firestore.instance.collection("Agent").getDocuments();
      ...
      Fluttertoast.showToast(msg: "username or password is invalid",
