  ...
  Future<void> init() async {
    try{
     ...
     userEmailId =  prefs.getString("userEmailId");
      ...
      DocumentSnapshot snapshot =await Firestore.instance.collection("Users").document(userPhone).get();
      Map<String,dynamic> userData = snapshot.data;
      pendigAmount = userData["pendingAmount"] ?? "0";
      debugPrint("INITPAM $pendigAmount");
      tournamentMapDb = userData["tournamentList"] ?? new Map<String,dynamic>();
      if(tournamentList.contains(widget.snapshot.documentID)||tournamentMapDb.containsKey(widget.snapshot.documentID)) {
        isApplied = true;
        setState(() {
                    ...
                    [
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List<Widget>.generate(questionMapList.length,(int index){
                              return Card(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: Text('${index+1}. ${questionMapList[index]["question"]}',
                                          style: TextStyle(
                                      ...
                                      Theme(
                                        ...
                                        child: IgnorePointer(
                                          ignoring: isApplied == true ? true :false,
                                          child: Wrap(
                                            children: <Widget>[
                                              Row(
                                                children: <Widget>[
                                                  Checkbox(
                                                    ...
                                                    onChanged: (value){
                                                      selectedOptionList[index] = 1;
                                                      setState(() {

                                                      });
                                                    },
                                                    value: selectedOptionList[index] == 1 ? true : false,
                                                  ),
                                                  Text(questionMapList[index]["option1"],
                                                    style: TextStyle(
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  Checkbox(
                                                    activeColor: Colors.green,
                                                    onChanged: (value){
                                                      selectedOptionList[index] = 2;
                                                      setState(() {

                                                      });
                                                    },
                                                    value: selectedOptionList[index] == 2 ? true : false,
                                                  ),
                                                  Text(questionMapList[index]["option2"],
                                                    style: TextStyle(
                                                        color: Colors.white70,
                                                        fontSize: 14
                                                    ),
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  Checkbox(
                                                    activeColor: Colors.green,
                                                    onChanged: (value){
                                                      selectedOptionList[index] = 3;
                                                      setState(() {

                                                      });
                                                    },
                                                    value: selectedOptionList[index] == 3 ? true : false,
                                                  ),
                                                  Text(questionMapList[index]["option3"],
                                                    style: TextStyle(
                                                        color: Colors.white70,
                                                        fontSize: 14
                                                    ),
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  Checkbox(
                                                    activeColor: Colors.green,
                                                    onChanged: (value){
                                                      selectedOptionList[index] = 4;
                                                      setState(() {

                                                      });
                                                    },
                                                    value: selectedOptionList[index] == 4 ? true : false,
                                                  ),
                                                  Text(questionMapList[index]["option4"],
                                                    style: TextStyle(
                                                        color: Colors.white70,
                                                        fontSize: 14
                                                    ),
                          ...
                          Container(
                            ...
                            child: RaisedButton(
                              ...
                              child: Text(isApplied ==false?"Submit" : "Already Submitted",
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 18
                              ),
  ...
  tournamentService()async{
    try{
      ...
      for(int i = 0 ; i< questions.length;i++) {
        ...
        if(isEmpty == true) {
          Fluttertoast.showToast(msg: "Please select valid option",
      ...
      await Firestore.instance.collection("Users").document(userPhone).setData({
        "tournamentList" : tournamentMapDb,
        "pendingAmount":pendigAmount
      },merge: true);
      await Firestore.instance.collection("Posts").document("Tournament").collection("Tournament").document(widget.snapshot.documentID).setData(
        {
