...
class _TournamentPageTabState extends State<TournamentPageTab> {
  ...
  Future<void> _onRefresh() async{
    documentList = await CommonFunction().getPost("Posts/Tournament/Tournament");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.isRedirectFromProfile==true ? "Applied" :  "Tournament",
        ),
      ),
          ...
          SliverPadding(
            ...
            sliver: SliverGrid.count(
              ...
              children: documentList.map((item) {
                return CommonWidget().commonCard(item,context,"Tournament",subtype: "Tournament");
              }).toList(),
            ),
          ) :
          (
