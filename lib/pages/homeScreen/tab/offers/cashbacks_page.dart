...
class _CashbacksPageDetailsState extends State<CashbacksPageDetails>with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    submitAnimCont = AnimationController(vsync: this,duration: Duration(milliseconds: 500));
    submitAnim  = Tween<double>(begin: 0.0,end: 1.0).animate(CurvedAnimation(
        parent: submitAnimCont,curve: Curves.ease
    ))
      ..addListener(() {
        setState(() {
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                                ...
                                delegate: SliverChildListDelegate(
                                  [
                                    ...
                                    Row(
                                      children: <Widget>[
                                        Expanded(
                                          child:  singleItem("DESCRIPTION" ,widget.snapshot["taskDesc"] ,crossAlign: CrossAxisAlignment.start),
                                        )
                                      ],
                                    ),
                                    Visibility(
                                    ...
                                    Row(
                                      children: <Widget>[
                                        Expanded(child: singleItem("INSTRUCTION" ,widget.snapshot["instruction"],crossAlign: CrossAxisAlignment.start ))
                                      ],
                                    ),
                                    SizedBox(
                                      height: 20,
                                    ...
                                    Visibility(
                                      visible: !widget.subType.toLowerCase().toString().contains("coupons") ?? false,
                                      child: Container(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: <Widget>[
                                            ...
                                            Container(
                                                ...
                                                child: Row(
                                                  children: <Widget>[
                                                    ...
                                                    Text(widget.snapshot["cashbackAmount"] ?? "",
                                                      style: TextStyle(
                                                          fontSize: 15,
                                                          color: Colors.green
                                                      ),
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                            child: Container(
                                                height: 50,
                                                child: widget.subType.toLowerCase().toString().contains("coupons") ==false ? RaisedButton(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          height: animation != null ?MediaQuery.of(context).size.height*0.25*animation.value : 0,
                          color: Colors.white,
                          child: Column(
                            children: <Widget>[
                              SizedBox(
                              ...
                              SizedBox(
                                height: animation!=null ? 30 * animation?.value : 0,
                              ),
                              Visibility(
                                visible: isShowWebsiteUrl ?? false,
                                child: Container(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: (){
                                      debugPrint("Pressed");
                                      _launchURL(widget.snapshot["link"] ?? "www.google.com");
                                    },
            ...
            Positioned(
              ...
              child: Material(
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  height: submitAnim != null ?MediaQuery.of(context).size.height*0.5*submitAnim.value : 0,
                  color: Colors.white,
                  child: ListView(
                    children: <Widget>[
                      SizedBox(
                        height: submitAnim!=null ? 50 * submitAnim?.value : 0,
                      ),
                      Container(
                        height: submitAnim!=null ? 50 * submitAnim?.value : 0,
                      ...
                      SizedBox(
                        height: submitAnim!=null ? 20 * submitAnim?.value : 0,
                      ),
                      GestureDetector(
                          onTap: (){
                      ...
                      SizedBox(
                        height: submitAnim !=null ?40 *submitAnim.value  : 0,
                      ),
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 60),
  ...
  Future<void> applyPostService() async {
    try {
      ...
      QuerySnapshot querySnapshot  = await Firestore.instance.collection("Posts").document(widget.type).collection(widget.subType).getDocuments();
      ...
      List<dynamic> offersList = localSnapshot["offersSubmittedBy"] ?? new List<dynamic>();
      ...
      if (workedImgFileUri != null) {
        ...
        await _firestore.collection("Posts").document(widget.type).collection(
            widget.subType).document(widget.snapshot.documentID)
            .setData({
          "offersSubmittedBy" : offersList
        }, merge: true);
