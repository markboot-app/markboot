...
class _OffersPageDetailsState extends State<OffersPageDetails> {
  ...
  Future<void> init() async {
    try{
      ...
      pendingPostList = prefs.getStringList("pendingPost") ?? new List<String>();
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              style: TextStyle(
                                ...
                                color: Color(textColors[random.nextInt(4)])
                              ),
                              ),
                            ),
                            SizedBox(
                  ...
                  delegate: SliverChildListDelegate(
                    [
                      ...
                      Container(
                        ...
                        child: Text(widget.snapshot["taskDesc"],
                          style: TextStyle(
                              fontSize: 13,
                              color: Colors.white
                          ),
                      ...
                      Visibility(
                          visible: widget.type.toLowerCase().contains("campaign") ?? false,
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                margin: EdgeInsets.only(top: 10),
                                child: Text(widget.snapshot["target"]??"",
                                  style: TextStyle(
                                      fontSize: 13,
                                      color: Colors.white
                                  ),
                            ...
                            Expanded(
                              child:Container(
                                ...
                                child: RaisedButton(
                                  ...
                                  child: Text(isApplied == false ?"Apply" : "Pending",
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white,
