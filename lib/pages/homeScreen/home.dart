...
class _HomeTabState extends State<HomeTab>with SingleTickerProviderStateMixin {
  List<String> introImages = ["assets/icons/list.png","assets/icons/money.png","assets/icons/purchase.png"];
  List<DocumentSnapshot> documentList ;
  List<DocumentSnapshot> headerSwipeList;
  TabController _tabController ;
  SwiperController swiperCont = new SwiperController();

  init() async {
    try {
      documentList = await CommonFunction().getPost("Posts/Gigs/Tasks")??  new List();
      int i = 1;
      headerSwipeList = new List();
      for(DocumentSnapshot snapshot in documentList) {
        headerSwipeList.add(snapshot);
        if(i == 3) break;
        i++;
      }
      debugPrint("DocumentSNAP $documentList");
...
//            ),
  ...
  Widget swiperBody() {
    return  Container(
      ...
      child: headerSwipeList == null ?Container(
        margin: EdgeInsets.only(top: 0),
                      child: Center(
                        child: Container(
                            width: 30,
      ...
      Swiper(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.fill,
                        image: NetworkImage(headerSwipeList[index]["imgUri"])
                    )
                ),
              ),
              Positioned(
        ...
        itemCount: headerSwipeList == null ? 0 :(headerSwipeList.length ),
        scale: 0.6,
        fade: 0.5,
...
class _RecentPageViewState extends State<RecentPageView> {
  ...
  init() async {
    try {
      QuerySnapshot gigsQuerySnap =await Firestore.instance.collection("Posts").document("Gigs").collection("Tasks").getDocuments();
      int len = 0;
      ...
      QuerySnapshot offersQuerySnap = await Firestore.instance.collection("Posts").document("Offers").collection("Cashbacks").getDocuments();
      len = 0;
      ...
      QuerySnapshot internshipQuerySnap = await Firestore.instance.collection("Posts").document("Internship").collection("Internship").getDocuments();
      len = 0;
      ...
      QuerySnapshot tournamentQuerySnap = await Firestore.instance.collection("Posts").document("Tournament").collection("Tournament").getDocuments();
      len = 0;
                ...
                children: <Widget>[
                  Container(
                    ...
                    width: 70,
                      ...
                      decoration: BoxDecoration(
                        color: activePageIndex == 0 ? Color(CommonStyle().lightYellowColor) : Colors.grey[300],
                  ...
                  Container(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                          color:  activePageIndex == 1 ? Color(CommonStyle().lightYellowColor) : Colors.grey[300],
                          borderRadius: BorderRadius.circular(20)
                      ),
                      child: Text("Offers",
                        style: TextStyle(
                  ...
                  Container(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                          color:  activePageIndex == 2 ? Color(CommonStyle().lightYellowColor) : Colors.grey[300],
                          borderRadius: BorderRadius.circular(20)
                      ),
                  ...
                  Container(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                          color:  activePageIndex == 3 ? Color(CommonStyle().lightYellowColor) : Colors.grey[300],
                          borderRadius: BorderRadius.circular(20)
                      ),
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) => TasksPageDetails(snapshot: gigsSnapList[index],type:"Gigs",subType:"Tasks",isDisabled: false,)
                  ));
                },
                child: Container(
                  decoration: BoxDecoration(
                      color:  Color(cardColor[index%4]),
                      borderRadius: BorderRadius.circular(10)
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Expanded(
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: NetworkImage(gigsSnapList[index]["imgUri"])
                              )
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Text(gigsSnapList[index]["companyName"] ?? "",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 18,
                          ),
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                        height: 60,
                        child: Text(gigsSnapList[index]["taskTitle"],
        ...
        return Container(
          ...
          child: Material(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) => CashbacksPageDetails(snapshot: offersSnapList[index],type:"Offers",subType:"Cashbacks",)
                  ));
                },
                child: Container(
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: NetworkImage(offersSnapList[index]["imgUri"])
                              )
                          ),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 4,right: 2,top: 2,bottom: 2),
                        child: Text(offersSnapList[index]["companyName"] ?? "",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 18,
                          ),
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                        height: 60,
                        child: Text(offersSnapList[index]["taskTitle"],
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 15
        ...
        return Container(
          ...
          child: Material(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) => InternshipPageDetails(snapshot: internshipSnapList[index],type:"Internship",subType:"Internship")
                  ));
                },
                child: Container(
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: NetworkImage(internshipSnapList[index]["imgUri"])
                              )
                          ),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 4,right: 2,top: 2,bottom: 2),
                        child: Text(internshipSnapList[index]["companyName"] ?? "",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 18,
                          ),
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                        height: 60,
                        child: Text(internshipSnapList[index]["taskTitle"],
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 15
        ...
        return Container(
          ...
          child: Material(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) => TournamentDetailsPage(snapshot: tournamentSnapList[index],type:"Gigs",subType:"Tasks")
                  ));
                },
                child: Container(
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: NetworkImage(tournamentSnapList[index]["imgUri"])
                              )
                          ),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 4,right: 2,top: 2,bottom: 2),
                        child: Text(tournamentSnapList[index]["companyName"] ?? "",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 18,
                          ),
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                        height: 60,
                        child: Text(tournamentSnapList[index]["taskTitle"],
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 15
