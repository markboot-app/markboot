...
class _AddPostAdminPageState extends State<AddPostAdminPage> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Center(child: commonWidget.commonTextField(controller: companyCont,inputText: "Company Name")),
            SizedBox(
              height: 20,
            ),
            Center(
            ...
            Center(child: commonWidget.commonTextField(controller: titleCont,inputText: "Task Title ")),
            Visibility(
              visible: (isShowTournamentUI) ?? false,
              child: tournamentPostUI(),
            ),
            Visibility(
              visible: (isShowTasksUI || isShowCampaignUI || isShowCashbacksUI || isShow50on500UI || isShowCouponsUI || isShowInternshipUI ) ?? false,
              child: Center(child: commonWidget.commonTextField(controller: descCont,inputText: "Description ",
              lines : 5
              )),
            ),
            Visibility(
              visible: (isShowCashbacksUI || isShow50on500UI) ?? false,
              child: Center(child: commonWidget.commonTextField(controller: cashbackCont,inputText: "Cashback Amount", keyboardType: TextInputType.number
              )),
            ),
            Visibility(
              visible: (isShowCashbacksUI  || isShow50on500UI || isShowCouponsUI) ?? false,
              child: Center(child: commonWidget.commonTextField(controller: instructionCont,inputText: "Instruction",
                  lines : 5,keyboardType: TextInputType.text
              )),
            ),
            Visibility(
              visible: (isShowCashbacksUI || isShow50on500UI || isShowCouponsUI||isShowTasksUI) ?? false,
              child: Center(child: commonWidget.commonTextField(controller: cashbackLinkCont,inputText: "Link", keyboardType: TextInputType.text
              )),
            ),
            Visibility(
              visible: isShowCampaignUI?? false,
              child: Center(child: commonWidget.commonTextField(controller: targetCont,inputText: "Target ",
                lines: 2
              )),
            ),
            Visibility(
                visible: (isShowTasksUI || isShowCampaignUI||isShowTournamentUI) ?? false,
                child: Center(child: commonWidget.commonTextField(controller: amountCont,inputText: "Reward",
                keyboardType: TextInputType.number
                ))),
            Visibility(
                visible: (isShowTasksUI || isShowCampaignUI||isShowCashbacksUI) ?? false,
                child: Column(
                  children: <Widget>[
                    SizedBox(
                    height: 10,
            ...
            Visibility(
              ...
              child: Center(child: commonWidget.commonTextField(controller: salaryCont,inputText: "Salary",
                  keyboardType: TextInputType.number
              ))
              ,),
            Visibility(
              visible: isShowInternshipUI??false,
              child: Center(child: commonWidget.commonTextField(controller: locationCont,inputText: "Location",
                  keyboardType: TextInputType.text
              ))
              ,),
            Visibility(
              visible: isShowInternshipUI??false,
              child: Center(child: commonWidget.commonTextField(controller: durationCont,inputText: "Duration",
                  keyboardType: TextInputType.text
              ))
              ,),
            Visibility(
              visible: isShowInternshipUI??false,
              child: Center(child: commonWidget.commonTextField(controller: categoryCont,inputText: "Category",
                  keyboardType: TextInputType.text
              ))
              ,),
            Visibility(
              visible: isShowInternshipUI??false,
              child: Center(child: commonWidget.commonTextField(controller: designationCont,inputText: "Designation",
                  keyboardType: TextInputType.text
              ))
              ,),
            Visibility(
              visible: isShowInternshipUI??false,
              child: Center(child: commonWidget.commonTextField(controller: startDateCont,inputText: "Start Date",
                  keyboardType: TextInputType.text
              ))
              ,),
            Visibility(
              visible: isShowInternshipUI??false,
              child: Center(child: commonWidget.commonTextField(controller: applyByCont,inputText: "Apply By",
                  keyboardType: TextInputType.text
              ))
              ,),
            Visibility(
              visible: isShowInternshipUI??false,
              child: Center(child: commonWidget.commonTextField(controller: skillsReqCont,inputText: "Skills Required",
                  keyboardType: TextInputType.text
              ))
              ,),
            SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                     if(questionCont.text.isEmpty) {
                       Fluttertoast.showToast(msg: "Enter question",
                       backgroundColor: Colors.red,textColor: Colors.white
                       );
                       return;
                     }
                     else if(option1Cont.text.isEmpty){
                       Fluttertoast.showToast(msg: "Enter option 1",
                           backgroundColor: Colors.red,textColor: Colors.white
                       );
                       return;
                     }
                     else if(option2Cont.text.isEmpty){
                       Fluttertoast.showToast(msg: "Enter option 2",
                           backgroundColor: Colors.red,textColor: Colors.white
                       );
                       return;
                     }
                     else if(option3Cont.text.isEmpty) {
                       Fluttertoast.showToast(msg: "Enter option 3",
                           backgroundColor: Colors.red,textColor: Colors.white
                       );
                       return;
                     }
                     else if(option4Cont.text.isEmpty) {
                       Fluttertoast.showToast(msg: "Enter option 4",
                           backgroundColor: Colors.red,textColor: Colors.white
                       );
                       return;
                     }
  ...
  checkTaskService()async {
    ...
    if(companyName.isEmpty) {
      ...
      Fluttertoast.showToast(msg: "Enter task title",
          backgroundColor: Colors.red,textColor: Colors.white
      );
      return;
    }
    ...
    if(isShowTasksUI == true) {
      if(amount.isEmpty) {
        Fluttertoast.showToast(msg: "Enter Reward",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      else if(_sampleFileImg == null ){
        Fluttertoast.showToast(msg: "Please capture sample picture",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      else if(link.isEmpty) {
        Fluttertoast.showToast(msg: "Enter Website link",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      ...
      if(amount.isEmpty) {
        ...
        Fluttertoast.showToast(msg: "Enter target",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      ...
      if(cashbackAmount.isEmpty) {
        Fluttertoast.showToast(msg: "Ente Cashback amount",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      else if(instruction.isEmpty) {
        Fluttertoast.showToast(msg: "Enter Instruction",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      else if(link.isEmpty) {
        Fluttertoast.showToast(msg: "Enter Link",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      if(isShowCashbacksUI == true) {
       if(_sampleFileImg == null) {
        Fluttertoast.showToast(msg: "upload sample picture",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      ...
      if(description.isEmpty) {
        ...
        Fluttertoast.showToast(msg: "Enter Duration",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      else if(category.isEmpty) {
        Fluttertoast.showToast(msg: "Enter category",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      } else if(designation.isEmpty) {
        Fluttertoast.showToast(msg: "Enter designation",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
        ...
        Fluttertoast.showToast(msg: "Enter Apply By ",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      else if(skillReq.isEmpty) {
        Fluttertoast.showToast(msg: "Enter Skill Required",
            backgroundColor: Colors.red,textColor: Colors.white
        );
        return;
      }
      ...
      if(questionMapList.length == 0) {
        Fluttertoast.showToast(msg: "Please add a question",
 ...
 Future<String> uploadToStorage(File uploadfile)async {
    final StorageReference storageReference = FirebaseStorage.instance.ref().child("image").child(uploadfile.path);
  ...
  savePostData(postData)async {
    try{
      ...
      await firestore.collection("Posts").document(widget.type).collection(widget.subtype).document().setData(postData)
      .whenComplete(()async {
        fieldClear();
        await CommonFunction().sendAndRetrieveMessage(descCont.text, titleCont.text);
      ...
      .catchError((error){
        Fluttertoast.showToast(msg: "getting some error.please contact to developer",
        backgroundColor: Colors.red,
          textColor: Colors.white
        );
      })
      .timeout(Duration(seconds:10 ),onTimeout: ()async{
        Fluttertoast.showToast(msg: "server not responding or your connection is too slow",
            backgroundColor: Colors.red,
            textColor: Colors.white
        );
      });
