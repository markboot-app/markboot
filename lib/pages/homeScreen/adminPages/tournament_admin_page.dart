...
class TournamentAdminDetailsPage extends StatefulWidget {
  ...
  @override
  _TournamentAdminDetailsPageState createState() => _TournamentAdminDetailsPageState();
}

class _TournamentAdminDetailsPageState extends State<TournamentAdminDetailsPage> with WidgetsBindingObserver{
                        ...
                        child: Container(
                          child: ListView.builder(itemBuilder: (context,index){
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Text('${index+1}. ${qustionList[index]["question"]}',
                                style: TextStyle(
                                  color: Colors.black,
                                ...
                                Text('Ans. ${qustionList[index]["answer"]}',
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 15
                                  ),
